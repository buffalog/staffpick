...
/**
 * Proof-of-credential attachment documents, stored as BLOBs directly in the database
 * (bytea) to keep the files inside the database's HIPAA BAA boundary — not on
...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('sp_credential_attachments', function (Blueprint $table) {
            ...
            $table->binary('content')->nullable(); // bytea; nulled on soft delete
